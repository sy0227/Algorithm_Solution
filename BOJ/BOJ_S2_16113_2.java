...
public class BOJ_S2_16113_2 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		System.out.println("공백이 아닌 열: " + Arrays.toString(col_txt));
...
//		System.out.println(Arrays.toString(col_one));
		...
		int[] real_idx_one = new int[idx_one];
		for(int i = 0, c = 0 ; i<col_one.length ; i++) {
			if(col_one[i] != 0) real_idx_one[c++] = col_one[i];
		}
		System.out.println("공백이 아닌 열 중 1인 열의 인덱스: " + Arrays.toString(real_idx_one));
